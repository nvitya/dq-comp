...
#define DQ_COMPILER_VERSION  "0.61.1"

/* CHANGE LOG
------------------------------------------------------------------------------------
v0.61.1:
  - -O1 optimization level does the inlining (so far it happened from -O2 and above)
v0.61.0:
...
v0.59.0:
  ...
  - Changed the `mod` operator for non-negative Euclidean modulo
v0.58.0:
  - BREAKING CHANGE: function -> func, endobj -> endobject
v0.57.0:
...
v0.55.10:
  - Language Server: compound member listing fix
v0.55.9:
...
v0.55.5:
  - VSCode plugin semantic analisis works
v0.55.4:
  - Language server json parsing fix
v0.55.3:
...
v0.52.5:
  - Added -Os and -Oz size optimization modes
v0.52.4:
  - working dynstrings option
v0.52.3:
  - "dynstrings" option preparation
v0.52.2:
  - Option processing rework
v0.52.1:
...
v0.40.7:
  - const blocks: const(uint32): ... endconst
v0.40.6:
...
v0.33.1:
  - str-v2 migration / 2: new strfunc adjusted using wchar
v0.33.0:
